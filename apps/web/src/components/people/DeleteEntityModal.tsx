  ...
  return createPortal(
    ...
    >
      <div
        ...
        aria-describedby="delete-entity-desc"
        ...
        <div className="mb-4 flex items-start justify-between gap-3">
          <div className="flex min-w-0 items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <p
                id="delete-entity-desc"
                className="m-0 mt-1 text-sm leading-relaxed text-[var(--nw-ink-3)]"
              >
                This permanently removes{" "}
                <span className="font-medium text-[var(--nw-ink-2)]">{name}</span> from your
                relationship memory, including linked follow-ups. This cannot be undone.
              </p>
            </div>
          </div>
          <button
