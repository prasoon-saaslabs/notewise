...
export function RecordIntelligencePanel({
  ...
  return (
    <section className="nw-accent-panel-gradient overflow-hidden rounded-2xl border border-[rgb(var(--nw-accent-rgb)_/_0.18)] shadow-[0_1px_0_var(--nw-glass-shadow)]">
      <header className="flex items-center gap-2 border-b border-[rgb(var(--nw-accent-rgb)_/_0.12)] px-4 py-3">
      ...
      <div className="flex flex-col gap-4 p-4">
        {!sessionLive ? (
          ...
          <div className="flex items-start gap-2 rounded-xl bg-[var(--nw-glass-bg-strong)] px-3 py-2 ring-1 ring-[var(--nw-border)]">
